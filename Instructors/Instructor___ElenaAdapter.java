...
/** elena's page adapter for tabs */
public class Instructor___ElenaAdapter extends FragmentStateAdapter {
    public Instructor___ElenaAdapter(@NonNull FragmentActivity fragmentActivity) {
